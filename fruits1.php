...
<h3 style="text-align:center;"><br> AUTUM </h3>
			<p style="text-align:center;">(MONSOON CROPS)</p>
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/orangecrop.png" alt="abc">
                    <div class="card-body">
			<p>Orange</p>
            ...
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/watermeloncrop.png" alt="">
                    <div class="card-body">
                        <p>Watermelon</p>
          ...
          <h3 style="text-align:center;"><br>RABI </h3>
			<p style="text-align:center;">(WINTER CROPS)</p>
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/bnp.png"alt="">
                    <div class="card-body">
                        <p>Banana</p>
           ...
           <h3 style="text-align:center;"><br> ZAID </h3> 
      				<p style="text-align:center;">(SUMMER CROPS)</p>
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
            ...
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/papayatree.png"alt="">
                    <div class="card-body">
                        <p>Papaya</p>
