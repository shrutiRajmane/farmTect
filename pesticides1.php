...
<h3 style="text-align:center;"><br>For Fruits</h3>
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/p3.png" alt="abc">
                    <div class="card-body">
                        <h3></h3>
          ...
          <h3 style="text-align:center;"><br>For Vegetables</h3>
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
           ...
           <h3 style="text-align:center;"><br>For Flowers</h3>       
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 footer-content">
                ...
                <strong><i class="fa-solid fa-envelope"></i> Email: <strong>farm-tech@gmail.com</strong></strong>
            </div>
