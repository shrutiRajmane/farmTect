...
<h3 style="text-align:center;"><br>FRUITY VEGITABLES</h3>
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/potatocrop.png" alt="abc">
                    <div class="card-body">
                        <p>Potato</p>
            ...
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/tomatocrop.png" alt="">
                    <div class="card-body">
                        <p>Tomato</p>
           ...
           <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/chilicrop.png" alt="">
                    <div class="card-body">
                        <p>Chilli<p>
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/brinjalcrop.png"alt="">
                    <div class="card-body">
                        <p>Brinjal</p>
            ...
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/carrotcrop.png"alt="">
                    <div class="card-body">
                        <p>Carrot</p>
           ...
           <h3 style="text-align:center;"><br>LEAFY VEGETABLES</h3>       
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4 py-4 py-md-0">
                <div class="card">
                    <img src="./image/cabbagecrop.png"alt="">
                    <div class="card-body">
                        <p>Cabbage</p>
